...
const HeroSection = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url("/oppenheimer.png")] bg-cover bg-center h-screen'> 
        ...
        <button onClick={() => {navigate("/movies")}} className='flex items-center gap-1 px-4 py-3 md:px-6 md:py-4 text-sm bg-primary hover:bg-primary:dull transition rounded-full font-medium cursor-pointer'>
            Explore Movies
