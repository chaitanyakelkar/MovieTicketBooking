  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <div className='overflow-x-auto pb-4'>
        <div className='group flex flex-wrap gap-4 mt-4 2-max'>
      ...
      <div className='mt-8'>
        ...
        <div className='inline-flex items-center gap-5 border border-gray-600 p-1 pl-3 rounded-lg'>
          <input min={0} type="datetime-local" value={dateTimeInput} onChange={(e) => setdateTimeInput(e.target.value)} className='outline-none rounded-md'/>
